...
| [Natural Stories story](https://vboyce.github.io/maze-demos/ns-maze-experiment/index.html) | A passage from the Natural Stories corpus, with distractors from [A-Maze of Natural Stories](https://escholarship.org/uc/item/6vh9d8zm). |

The index page is at [vboyce.github.io/maze-demos](https://vboyce.github.io/maze-demos/).

The source for every demo is in [jspsych-maze](https://github.com/vboyce/jspsych-maze) (`source/src/<demo>-experiment.js`). The built files are in [maze-demos](https://github.com/vboyce/maze-demos). To start your own experiment, copy the demo closest to what you need.
