...
> The code on this page is for the older Ibex implementation, but the advice applies to any Maze experiment. For jsPsych, see the [demos](demos.md); the vignettes demo shows a "Story 1/2" progress header, and the kid-friendly demo shows a progress bar and breaks.
