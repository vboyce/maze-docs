...
> The code snippets on this page are for the older Ibex implementation. In [jspsych-maze](jspsych.md), the delay is the `delay` parameter (default 500 ms), and the messages are `error_message` and `redo_message`.
